...
class LaporanController extends Controller {
    public function laporan(Request $request) {
        ...
        $rules = [
            ...
            'provinsi_pelapor' => 'required|max:255',
            'kota_pelapor' => 'required|max:255',
            'kecamatan_pelapor' => 'required|max:255',
            'kelurahan_pelapor' => 'required|max:255',
            ...
            'provinsi_terlapor' => 'required|max:255',
            'kota_terlapor' => 'required|max:255',
            'kecamatan_terlapor' => 'max:255',
            'kelurahan_terlapor' => 'max:255',
