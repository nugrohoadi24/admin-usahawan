...
<header id="header" class="header">
    <div class="top-left">
        <div class="navbar-header">
            <a class="navbar-brand" href="/"><img src="/images/pks-logo.png" alt="Logo"></a>
            <a class="navbar-brand hidden" href="/"><img src="/images/pks-logo.png" alt="Logo"></a>
    ...
    <div class="top-right">
        <div class="header-menu">
            ...
            <div class="dropdown float-right fix-dropdown">
                <div class="dropdown">
                    <a class="dropdown-toggle fix-dropdown mr-10" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                        {{ Auth::user()->name }}
                    </a>
