    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="">
                    <a href="{{ route('laporan.verifikasi') }}"> <i class="menu-icon fa fa-check"></i>Verifikasi Laporan</a>
                </li>
                ...
                <li class="">
                    <a href="{{ route('permohonan.verifikasi') }}"> <i class="menu-icon fa fa-check"></i>Verifikasi Permohonan</a>
                </li>
            </ul>
        </div>
    </nav>
